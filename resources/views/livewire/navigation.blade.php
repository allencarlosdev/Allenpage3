<nav class="bg-white h-24 fixed w-full" x-data="{ open:false }">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="hidden sm:block sm:ml-6 self-center">
                ...
                @foreach($categories as $category)
                    <a href="#" class="text-gray-700 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{{ $category->name }}</a>
                @endforeach
                </div>
            </div>
            </div>
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
        <div class="px-2 pt-2 pb-3 space-y-1 absolute w-full bg-gray-300">
            ...
            @foreach($categories as $category)
            <a href="#" class="bg-white text-gray-700 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">{{ $category->name }}</a>
            @endforeach
        </div>
    </div>
</nav>
